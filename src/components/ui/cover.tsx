...
export const Cover = ({
  ...
  const [hovered, setHovered] = useState(true); // Set hovered to true by default
  ...
  return (
    <div
      ref={ref}
      className="relative group/cover inline-flex items-center justify-center bg-black px-2 py-2 transition duration-200 rounded-sm"
    >
      <AnimatePresence>
        {hovered && (
          <motion.div
